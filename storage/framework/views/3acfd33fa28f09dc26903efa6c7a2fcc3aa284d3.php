...
<?php $__env->startSection('header'); ?>
    <div class="page-header">
        <h1><i class="glyphicon glyphicon-edit"></i> Projects / Edit #<?php echo e($project->id); ?></h1>
    </div>
<?php $__env->stopSection(); ?>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form action="<?php echo e(route('projects.update', $project->id)); ?>" method="POST">
                ...
                <div class="row">
                    <div class="col-md-9">
                        <input type="text" name="name" class="form-control" dir="rtl" value="<?php echo e($project->name); ?>">
                    </div>
                    <div class="col-md-3">
                ...
                <div class="row">
                    <div class="col-md-9">
                        <input type="text" name="code" class="form-control" dir="rtl" value="<?php echo e($project->code); ?>">
                    </div>
                    <div class="col-md-3">
